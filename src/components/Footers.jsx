...
function Footer() {
  ...
  return (
    <div className="bg-VeryDarkBlue  w-full m-0 py-4 ">
      <div className="w-3/4 py-8 mx-auto text-white flex flex-col-reverse gap-y-12 justify-between items-center md:flex-row md:w-3/4">
        <div className="w-full flex flex-col-reverse justify-between  gap-y-8 items-center md:flex-col md:w-1/3">
          <div className="">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              role="img"
              aria-label="Logo Manage"
              width="146"
              height="24"
            >
          ...
          <div className="flex gap-x-5 md:gap-x-2">
            <img src="images/icon-facebook.svg" alt="" className="w-[25px]" />
        ...
        <div className="w-2/3 mx-auto  flex justify-between md:w-1/3 ">
        ...
        <div className="flex flex-col  gap-y-10 items-left">
          <div className="flex gap-x-2">
            <input
              type="text"
              className="w-2/3 rounded-2xl py-2  px-4 bg-white text-white"
              placeholder="updates in your inbox"
            />
            <button className="rounded-2xl w-[50px] h-[50px] p-2 bg-[#f25f3a]">
              GO
            </button>
          </div>
          <div className="text-sm">copyright 2025. All Right reserved</div>
        </div>
      </div>

      <div className="text-center text-sm text-white">
        challenge by{" "}
        <span className="hover:text-[#f25f3a] font-bold mx-1">
          Frontend Mentor
        </span>
        codedy by <span className=""></span>
        <a href="" className="">
          EbukaNathan
        </a>
      </div>
